...
public class PanelMovie extends javax.swing.JPanel {
     ...
     */
    private String filmId, graphicUrl, title, duration,ratingFormat;
    public PanelMovie(String filmId, String graphicUrl, String title,String duration,String ratingFormat) throws IOException {
        initComponents();
        this.filmId = filmId;
    ...
    public void setData() throws NullPointerException, IOException{
