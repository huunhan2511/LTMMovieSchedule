...
public class Film {
    ...
    public Film(String title, String apiFilmId, String link, String duration, String apiRatingFormat, String apiGenreName, String apiImdb, String apiRottenTomatoes, String apiMetacritic, String graphicUrl, String synopsisEn, String trailerUrl) {
        Title = title;
        ApiFilmId = apiFilmId;
        Link = link;
        Duration = duration;
